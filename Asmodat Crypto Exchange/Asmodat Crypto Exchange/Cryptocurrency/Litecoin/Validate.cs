...
namespace Asmodat.Cryptocurrency.Litecoin
{
    public class Litecoin
    {
        ...
        public static bool IsValid(string address)
        {
            ...
            if (validationresponse == Litecoin.Response_AddressIsValid)
                return true;
            else return false;
        ...
        public static string ValidateAddress(string address)
        {
            try
            {
                ...
                if (address.Length > 33) return "to long";

                Regex regex = new Regex("^L[a-km-zA-HJ-NP-Z1-9]{26,33}$");
