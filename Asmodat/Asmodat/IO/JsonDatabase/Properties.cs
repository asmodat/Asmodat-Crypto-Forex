...
namespace Asmodat.IO
{
    public partial class JsonDataBase<TJson> : IDisposable
    {
        ...
        public Dictionary<string, TJson> Data { get; private set; } = new Dictionary<string, TJson>();

        public const string extension = @".jdb";
        ...
        /// <summary>
        /// Returns path to file based on key
        /// </summary>
        /// <param name="key"></param>
        /// <returns></returns>
        public string GetPath(string key)
        {
            return Path + @"\" + key + extension;
        }
