...
namespace Asmodat.IO.Devices.EnableHardware
{
    public static class EnableHardware
    {
        ...
        public static void EnableDevice(string match, bool disable = true)
        {
            EnableDevice(n => n.ToUpperInvariant().Contains(match), disable);
        }
    }
}
