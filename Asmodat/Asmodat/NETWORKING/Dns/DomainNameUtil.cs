...
namespace Asmodat.Networking.Dns
{
    public class DomainNameUtil
    {
        ...
        static List<IPAddress> GetRootDnsServers()
        {
            ...
            rootServers.Add(IPAddress.Parse("198.41.0.4"));
            rootServers.Add(IPAddress.Parse("192.228.79.201"));
            rootServers.Add(IPAddress.Parse("192.33.4.12"));
            rootServers.Add(IPAddress.Parse("199.7.91.13"));
            rootServers.Add(IPAddress.Parse("192.203.230.10"));
            rootServers.Add(IPAddress.Parse("192.5.5.241"));
            rootServers.Add(IPAddress.Parse("192.112.36.4"));
            rootServers.Add(IPAddress.Parse("128.63.2.53"));
