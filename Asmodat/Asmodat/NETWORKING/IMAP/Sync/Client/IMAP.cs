...
namespace Asmodat.InterIMAP
{
    ...
    public class IMAP : IMAPBase
    {
        ...
        const int m_currentConMsgCount = 0;
        ...
        public bool Login(string sHost, int iPort, string sUserId, string sPassword, bool useSSL)
        {
            m_useSSL = useSSL;

            try
            {
                _Login(sHost, iPort, sUserId, sPassword, useSSL);
            }
            catch (Exception)
            {
                return false;
        ...
        private void _Login(string sHost, int nPort, string sUserId, string sPassword, bool useSSL)
        {
            m_useSSL = useSSL;
