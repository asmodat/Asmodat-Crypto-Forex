...
{
    public partial class ThreadedRadioButton : RadioButton
    {
        public void Initialize()
        {
            ...
            Initialized = true;
            this.CheckedChanged += ThreadedRadioButton_CheckedChanged;
        }

        private void ThreadedRadioButton_CheckedChanged(object sender, EventArgs e)
        {
